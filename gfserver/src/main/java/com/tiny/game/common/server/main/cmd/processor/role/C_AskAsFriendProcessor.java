...
@NetCmdAnnimation(cmd = C_AskAsFriend.class)
public class C_AskAsFriendProcessor extends AbstractPlayerCmdProcessor {

	@Override
	public void process(Role role, NetSession session, NetMessage msg) {
		C_AskAsFriend req = NetUtils.getNetProtocolObject(C_AskAsFriend.PARSER, msg);
		RoleService.askAsFriend(role, session, req);
	}
