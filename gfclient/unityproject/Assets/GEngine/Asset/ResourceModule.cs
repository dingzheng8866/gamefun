...
namespace GEngine.Asset
{
    ...
    public class ResourceModule : MonoBehaviour
    {
        ...
        {
            get { return GEngine.GEngineDef.ProductRelPath; }
        }
        ...
        {
            return string.Format(path + GEngineDef.AssetBundleExt, formats);
        }
        ...
        public static bool TryGetInAppStreamingUrl(string url, bool withFileProtocol, out string newUrl)
        {
            ...
            if (Application.isEditor)
            {
                ...
                if (!result)
                {
                    Debug.LogErrorFormat("[大小写敏感]发现一个资源 {0}，大小写出现问题，在Windows可以读取，手机不行，请改表修改！", url);
                }
            }
            return true;
        }
        ...
        {
            get { return GEngineDef.StreamingBundlesFolderName; }
        }
        ...
        public static string EditorAssetBundleFullPath
        {
            get
            {
                string editorAssetBundlePath = Path.GetFullPath(GEngineDef.AssetBundleBuildRelPath); // for editoronly
        ...
        */
        ...
        public static void LogLoadTime(string resType, string resPath, System.DateTime begin)
        {
            ...
            Debug.LogFormat("[Load] {0}, {1}, {2}s", resType, resPath, (System.DateTime.Now - begin).TotalSeconds);
        }
